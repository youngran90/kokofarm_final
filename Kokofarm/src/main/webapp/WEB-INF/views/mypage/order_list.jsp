	...
	<div class="row">
	 <%@include file="./Mypage.jsp"%>
        ...
        <div class="pagination-in" style="margin-left: 40%">
         <ul class="pagination" >
			<li><a href="/mypage/order_list?page=${pageMaker.startPage}">처음</a></li>
			<c:if test="${pageMaker.prev}">
				<li><a href="/mypage/order_list${pageMaker.makeQuery(pageMaker.startPage - 1) }">&laquo;</a></li>
			</c:if>
			<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.lastPage}" var="idx">
				...
				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					<li><a href="/mypage/order_list${pageMaker.makeQuery(pageMaker.endPage +1) }">&raquo;</a></li>
				</c:if>
				<li><a href="/mypage/order_list?page=${pageMaker.endPage}">마지막</a></li></ul>
        </div>
      </div>
