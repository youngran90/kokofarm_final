package kokofarm.mainImage.domain;
...
public class AuctionListDTO implements Serializable {
	...
	public String toString() {
		return "AuctionListDTO [auction_no=" + auction_no + ", auction_name=" + auction_name + ", auction_group="
				...
				+ seller_no + ", tender_no=" + tender_no + ", tender_price=" + tender_price + ", tender_date="
				+ tender_date + "]";
	}
