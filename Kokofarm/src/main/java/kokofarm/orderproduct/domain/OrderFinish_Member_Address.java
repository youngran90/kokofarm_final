...
public class OrderFinish_Member_Address implements Serializable{
	private String recipientpost;
	private String address;
	private String address_sub;
	
	public OrderFinish_Member_Address() {
	}

	public OrderFinish_Member_Address(String recipientpost, String address, String address_sub) {
		super();
