...
public class OrderFinish_Member_Phonenum implements Serializable{
	private String mobileReceiver1;
	private String mobileReceiver2;
	private String mobileReceiver3;
	
	public OrderFinish_Member_Phonenum() {}

	public OrderFinish_Member_Phonenum(String mobileReceiver1, String mobileReceiver2, String mobileReceiver3) {
